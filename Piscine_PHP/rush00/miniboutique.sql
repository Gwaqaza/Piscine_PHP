...
INSERT INTO `categories_products` (`id`, `id_product`, `id_categories`) VALUES
(5, 26, 3),
(6, 27, 3),
(7, 28, 3),
(8, 29, 3),
...
INSERT INTO `client` (`id`, `email`, `name`, `firstname`, `mdp`, `address`, `code_postal`, `city`, `telephone`) VALUES
...
INSERT INTO `order` (`id`, `id_client`, `price`) VALUES
(22, 10, 4678);
...
INSERT INTO `client_order` (`id`, `id_product`, `id_order`, `price`, `quantity`) VALUES
(28, 38, 22, 50, 2),
(29, 24, 22, 4578, 1);
...
ALTER TABLE `categories_products`
  ADD PRIMARY KEY (`id`), ADD KEY `id_product` (`id_product`), ADD KEY `id_categories` (`id_categories`);
...
--
-- Index pour la table `client_order`
--
ALTER TABLE `client_order`
  ADD PRIMARY KEY (`id`), ADD KEY `id_product` (`id_product`), ADD KEY `id_order` (`id_order`);
...
--
-- AUTO_INCREMENT pour la table `client_order`
--
ALTER TABLE `client_order`
...
--
ALTER TABLE `client_order`
ADD CONSTRAINT `fk_produit` FOREIGN KEY (`id_order`) REFERENCES `order` (`id`) ON DELETE CASCADE,
ADD CONSTRAINT `fk_commande` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`);
