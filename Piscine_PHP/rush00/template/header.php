...
<?php
				if(isset($_SESSION['loggued_on_user']) && $_SESSION['loggued_on_user'] != "")
				{
					...
					echo "<li><a href='logout.php'>Sign out<br></a></li>";
				}
				else
				{
?>
				<li><a href="create.php">Create an account<br></a></li>
				<li><a href="create.php">Log in<br></a></li>

<?php
				}
?>
			<li><a href="basket.php">Basket <br> <?PHP echo $_SESSION['total_cart']; ?> items</a></li>
			</ul>
		</div>
		<a href="index.php">
